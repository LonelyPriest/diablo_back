...
function wgoodConfig (angular){
	...
	"wgoodApp", ['ui.bootstrap', 'ngRoute', 'ngResource', 'LocalStorageModule',
		     'diabloAuthenApp', 'diabloPattern', 'diabloUtils',
		     'diabloFilterApp', 'diabloNormalFilterApp', 'userApp'])
	...
	$routeProvider.
		...
		resolve: angular.extend({}, brand, firm, type, color, s_group, color_type, user, base)
	    }).
	    when('/wgood_new', {
		templateUrl: '/private/wgood/html/wgood_new.html',
		controller: 'wgoodNewCtrl',
		resolve: angular.extend({}, user, brand, firm, type, s_group, color_type, base)
	    }).
	    when('/setting/size', {
