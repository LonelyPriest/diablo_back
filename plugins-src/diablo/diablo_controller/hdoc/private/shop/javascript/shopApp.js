...
function shopConfig (angular){
	...
	"shopApp", ['ui.bootstrap', 'ngRoute', 'ngResource', 'LocalStorageModule',
    ...
    shopApp.controller("newShopCtrl", newShopProvide);

    shopApp.controller("shopDetailCtrl", shopDetailProvide);
...
var shopDetailProvide = function(
    $scope, $q, diabloUtilsService, shopService, filterEmployee, user){
